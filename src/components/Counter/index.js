		...
		return (
			<>
				...
				<div style={style.counterContainer} className="counter-container">
					...
					<button style={style.btn} className="btn btn-primary" onClick={this.incrementCount}>
						Increment
					</button>
					<button style={style.btn} className="btn btn-primary" onClick={this.decrementCount}>
						Decrement
					</button>
				</div>
			</>
