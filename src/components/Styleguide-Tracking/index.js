						...
						<div className="row">
							<fieldset className="form-group col-sm">
								...
								<p>
									...
									Service tracks page views by default unless <code>tracking=false</code> is passed in
									its query string.
								</p>
							...
							<fieldset className="form-group col-sm">
								...
								<p>
									The tracking API supports pushing a whole batch of events in a single request. This
									can be useful for queuing strategies or offline PWA usage.
								</p>
								<button
									type="button"
						...
						<div className="row">
							<fieldset className="form-group col-sm">
								...
								<p className="alert alert-warning">
									...
									Profile. If your interactions are not showing up in Experience Profile, you may need
									to{' '}
